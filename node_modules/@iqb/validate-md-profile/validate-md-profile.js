    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                allProfiles_1 = [];
                fs = require('fs');
                return [4 /*yield*/, mdConfig.profiles.reduce(function (prevPromise, profile) { return __awaiter(void 0, void 0, void 0, function () {
                        var validated;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
            ...
            case 1:
                ...
                if (fs.existsSync(mdTargetFolder)) {
                    ...
                    if (mdConfig.creator)
                        mdContent_1 += "Creator: ".concat(mdConfig.creator, "\n\n");
                    if (mdConfig.maintainer !== mdConfig.creator && mdConfig.maintainer !== undefined)
                            ...
                            p.groups.forEach(function (g) {
                                ...
                                g.entries.forEach(function (e) {
                                    ...
                                    if (e.type === 'vocabulary' && e.parameters) {
                                        ...
                                        mdContent_1 += "[Vokabular](".concat(p_1.url, ") | url: '").concat(p_1.url, "', ").concat(p_1.allowMultipleValues ? 'Mehrfachauswahl' : 'Einmalauswahl').concat(p_1.maxLevel > 0 ? levelText : '').concat(p_1.selectionMode === undefined || p_1.selectionMode === 'dialog' ? ', Dialogbox' : ', integrierte Darstellung').concat(p_1.hideNumbering ? ', Nummerierung unterdrückt' : '').concat(p_1.hideTitle ? ', Titel unterdrückt' : '').concat(p_1.hideDescription ? ', Beschreibung unterdrückt' : '').concat(p_1.addTextLanguages && p_1.addTextLanguages.length > 0 ? ', mit Texteingabe in Sprache(n): ' + p_1.addTextLanguages.join('/') : '');
                                    }
                                        ...
                                        mdContent_1 += "Zahl | Kommastellen: ".concat(p_3.digits, ", Mindestwert: ").concat(p_3.minValue === undefined ? 'kein' : p_3.minValue, ", Maximalwert: ").concat(p_3.maxValue === undefined ? 'kein' : p_3.maxValue).concat(p_3.isPeriodSeconds ? ', als Sekunden' : '');
                                    }
                                    else if (e.type === 'boolean' && e.parameters) {
                                        var p_4 = e.parameters;
                                        mdContent_1 += "Ja/Nein | Text f\u00FCr WAHR: ".concat(p_4.trueLabel[0].value, ", Text f\u00FCr FALSCH: ").concat(p_4.falseLabel[0].value);
                                    }
